...
const SECTIONS = [
  ...
  ["THE PRO SHOP", ["A rotating shipment of one-of-a-kind gear: every series brings new stock and the old shipment leaves forever. Items boost their slot's attribute by a PERCENTAGE (+5% COMMON, +10% RARE, +15% LEGENDARY) and rarer pieces carry a ±4% side-effect on a second attribute. Boosts multiply the player's rating and cap at 99 — gear helps the great more than the mediocre, but nobody passes perfect.", "Each winter the WINTER CATALOG arrives: rare and legendary stock only, timed for your playoff money. Gear stacks above a player's ceiling and never ages — but it travels with him if he's traded or released to the draft (draft rookies inherit it)."]],
